...
def facecrop(org_path,save_path,face_detector,face_predictor,period=1,num_frames=30):
...
if __name__=='__main__':
    ...
    if args.dataset=='Original':
        dataset_path='../train_self/original_sequences/youtube/{}/'.format(args.comp)
    ...
    for i in tqdm(range(n_sample)):
        ...
        facecrop(movies_path_list[i],save_path='../',num_frames=args.num_frames,face_predictor=face_predictor,face_detector=face_detector)
