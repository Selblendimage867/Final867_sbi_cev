...
class SBI_Dataset(Dataset):
	def __init__(self,phase='train',image_size=224,n_frames=30):
	...
	def __getitem__(self,idx):
		...
		while flag:
			try:
				...
				#bboxes=json.load(filename.replace('.png','.npy').replace('/frames/','/retina/'))[:2]
				S = filename.replace('/frames/','/boxes/')
				S = re.split(r'[./]', S)
				X = '../'+S[3]+'/'+S[4]+'/'+S[5]+'.json'
				indexX = int(S[6])
				indexX = str(indexX)
				...
				for i in range(len(bboxes)):
					b_x= np.array([int(b * 2) for b in bboxes[i]])
					iou=IoUfrom2bboxes(bbox_lm,b_x.flatten())
					if iou_max<iou:
						bbox=b_x
						iou_max=iou
				...
				#cv2.imwrite('/home/zihanzhang/Documents/crossefficient/Combining-EfficientNet-and-Vision-Transformers-for-Video-Deepfake-Detection/cross-efficient-vit/003.png', img_r)
				#cv2.imwrite('/home/zihanzhang/Documents/crossefficient/Combining-EfficientNet-and-Vision-Transformers-for-Video-Deepfake-Detection/cross-efficient-vit/004.png', img_f)
	...
	def randaffine(self,img,mask):
		...
		#cv2.imwrite('/home/zihanzhang/Documents/crossefficient/Combining-EfficientNet-and-Vision-Transformers-for-Video-Deepfake-Detection/cross-efficient-vit/003.png', img)
	...
	def self_blending(self,img,landmark):
		...
		cv2.imwrite('/home/zihanzhang/Documents/crossefficient/Combining-EfficientNet-and-Vision-Transformers-for-Video-Deepfake-Detection/cross-efficient-vit/003.png', img)
		cv2.imwrite('/home/zihanzhang/Documents/crossefficient/Combining-EfficientNet-and-Vision-Transformers-for-Video-Deepfake-Detection/cross-efficient-vit/004.png', img_blended)
		'''
